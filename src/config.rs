...
pub use schema::{
    ...
    DisplayDenominationConfig, JournalTradesView, KeroseneConfig, MAX_ALFRED_POPUP_SCALE,
...
pub use secrets::{
    ...
    store_keychain_secrets, store_keychain_secrets_with_profile_removals, take_secret_warnings,
};
