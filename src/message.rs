...
pub(crate) enum Message {
    ...
    ConsoleTick,
    ConsoleTogglePause,
    ConsoleProviderChanged(crate::network_activity::Provider),
    ConsoleFilterChanged(crate::console_state::ConsoleFilter),
    ConsolePageChanged(usize),
    ConsoleScrolled(iced::widget::scrollable::Viewport),
    ConsoleClear,
    OpenAgentWindow,
    ...
    ListingsTick,
    RefreshListings,
    ListingsFilterChanged(crate::market_state::listings::ListingsFilter),
    ListingsLoaded(u64, Box<crate::market_state::listings::ListingsSnapshot>),
    ListingsSaved(Result<(), String>),
    AddHypeEtfsPane,
