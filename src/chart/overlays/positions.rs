...
use crate::chart::drawing::{
    AxisBadgeStyle, SegmentedHLineStyle, stroke_projected_hline,
        ...
        IdxToCx: Fn(usize) -> f32,
    {
            ...
            && ctx.price_range > 0.0
        {
            ...
            if entry_y >= -10.0 && entry_y <= ctx.price_h + 10.0 {
                ...
                let visual_entry_y = ctx.fisheye.project(Point::new(POSITION_LABEL_X, entry_y)).y;
                let label_origin = Point::new(
                    POSITION_LABEL_X,
                    visual_entry_y - POSITION_LABEL_HEIGHT * 0.5,
                );
                ...
                ctx.frame.fill_text(canvas::Text {
                    ...
                    position: Point::new(POSITION_LABEL_TEXT_X, visual_entry_y),
                    color: Color::BLACK,
